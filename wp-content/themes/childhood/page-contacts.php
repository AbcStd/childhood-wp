                  ...
                  <div class="contacts__phones">
                      <div class="contacts__phoneblock">
                          ...
                          <div class="contacts__phonewrap">
                              ...
                              <a href="<?php the_field('phone', 82); ?>"><?php the_field('phone', 82); ?></a>
                          </div>
                      </div>
                      <div class="contacts__phoneblock">
                          Телефон №2
                          <div class="contacts__phonewrap">
                              ...
                              <a href="<?php the_field('phone2', 82); ?>"><?php the_field('phone2', 82); ?></a>
                          </div>
                      </div>
                  </div>
                  <div class="contacts__mail">
                      Или напишите нам на почту
                      <a href="<?php the_field('mail', 82); ?>"><?php the_field('mail', 82); ?></a>
          ...
          <div class="col-md-6">
              <div class="title contacts__minititle">Оставьте ваш отзыв</div>
                  <div class="contacts__feed">
                      <?php echo do_shortcode('[contact-form-7 id="246" title="Форма отзывов"]'); ?>
                  </div>                       
          </div>
      </div>
      <div class="row mt70">
